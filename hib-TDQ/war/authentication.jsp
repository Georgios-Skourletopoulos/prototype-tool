...
<!-- This jsp file displays the corresponding web page when the AuthenticationServlet is called. -->
								...
								<div class="12u skel-cell-mainContent">
									...
									<div id="content">
										<div class="actions actions-centered">
											...
											<p>You are trying to access a restricted area.</p>
											<form action="/profile" method="get">
												<p>
													Your job position is <i>${user.jobId.name}</i>. Please
													visit your <input type="submit"
														class="button button-style3 button-small" value="Profile" />
													in order to amend your job position.
												</p>
											</form>
										</div>
									</div>
