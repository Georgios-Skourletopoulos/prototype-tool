...
<!-- This jsp file displays the corresponding web page when the BuyingServlet is called. -->
							...
							<div class="row">
								<div class="12u skel-cell-mainContent">
									...
									<div id="content">
										...
										<form method="get" action="/buy" data-validate="parsley">
											...
											<table class="style1">
												<tr>
													...
													<td><input type="text" class="text"
														name="tdInBuyingName" id="contact-name"
														value="${TDinBuyingShared.name}" data-type="alphanum"
														data-required="true" data-maxlength="45" /></td>
												</tr>
												<tr>
												...
												<tr>
													<th>Average variation in monthly subscription price
														for the declared years of ROI (in %)</th>
													<td><fmt:formatNumber type="number"
															maxFractionDigits="2"
												...
												<tr>
													<th>Average variation in the monthly cost for
												...
												<div class="12u">
													<ul class="actions">
														...
														<input type="${submitSharedDisabled}"
															...
															name="submitSharedButton"
															onclick="setDispatchActionBuying('submitShared')" />
