...
<!-- This jsp file displays the corresponding web page when the ErrorServlet is called. -->
								...
								<div class="12u skel-cell-mainContent">
									...
									<div id="content">
										<div class="actions actions-centered">
											<p>
												<b>You have encountered an error.</b>
										</div>
										...
										<p>${message}</p>
										<p>You will be redirected to the main page in 15
											seconds...</p>
									</div>
								</div>
