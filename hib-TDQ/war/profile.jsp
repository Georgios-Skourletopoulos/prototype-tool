...
<!-- This jsp file displays the corresponding web page when the ProfileServlet is called. -->
...
<body class="no-sidebar">
	...
	<div class="wrapper wrapper-style3">
		<div class="title">Profile specification</div>
		<div class="container">
			<div class="row">
				<div class="12u">
							...
							<div class="row">
								<div class="12u skel-cell-mainContent">
									...
									<div id="content">
										...
										<form method="get" action="/profile" data-validate="parsley">
												...
												<div class="row half">
													<div class="6u">
														...
														<input type="text" class="text" name="firstName"
															id="contact-name" value="${firstNameValue}"
												...
												<div class="row half">
													<div class="6u">
														...
														<input type="text" class="text" name="lastName"
															id="contact-name" placeholder="${lastNamePlaceHolder}"
															value="${lastNameValue}" data-type="alphanum"
															data-required="true" data-maxlength="45" />
													</div>
												</div>
												<div class="row half">
													<div class="6u">
														<h3>Job position</h3>
														<select name="jobPosition"> ${jobSelect}
														</select>
													</div>
												</div>
												<div class="row half">
													<div class="6u">
														...
														<input type="text" class="text" name="companyName"
															id="contact-name" placeholder="${companyPlaceHolder}"
															value="${companyValue}" data-type="alphanum"
												...
												<div class="row half">
													<div class="6u">
														...
														<input type="text" class="text" name="location"
															id="contact-name" placeholder="${locationPlaceHolder}"
															value="${locationValue}" data-type="alphanum"
															data-required="true" data-maxlength="45" />
													</div>
												</div>
												<div class="row">
													<div class="12u">
														<ul class="actions">
															<li><input type="submit"
																...
																onClick="setDispatchAction('save')" /></li>
