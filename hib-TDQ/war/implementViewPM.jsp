									...
									<div id="content">
										...
										<table class="style1">
											<tr>
												...
												<td colspan="3">${costForImplementingShared.name}</td>
											</tr>
											<tr>
											...
											<tr>
												<th>Weighted priority for the Configuration process (in
													%)</th>
												<td colspan="3"><fmt:formatNumber type="number"
														maxFractionDigits="2"
											...
											<tr>
												<th>Weighted priority for the Deployment process (in %)</th>
												<td colspan="3"><fmt:formatNumber type="number"
														maxFractionDigits="2"
